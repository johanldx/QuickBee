...
<html lang="fr">
    ...
    <?php displayMessage() ?>
        <div class="d-flex">
            ...
            <main class="main p-3">
                <h1 class="mt-3 mb-3 fs-3 text-start">Newsletter</h1>

                <div class="bg-body-tertiary rounded p-3">
                    <form method="post" action="/admin/backend/create-newsletter-process.php">
                            ...
                            <div class="form-floating mt-3">
                                <textarea class="form-control" placeholder="Leave a comment here" name="content" id="floatingTextarea2" style="height: 100px" required></textarea>
                                <label for="floatingTextarea2">Contenue</label>
                            </div>
                            <div class="d-flex justify-content-start gap-2 mt-4">
                                <a href="/admin/manage/newsletters.php" class="btn btn-secondary">Annuler</a>
