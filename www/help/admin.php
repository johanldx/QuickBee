...
$db = new Database();
$conn = $db->connect();
$sql = "SELECT id, active FROM conversation";
$params = [];
...
writeLog('/help/admin.php', "Visité la page de support", getUserIP(), $_SESSION['logged']);
            ...
            <aside id="sidebar">
                ...
                <ul class="sidebar-nav list-unstyled scrollable-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="admin?id=<?php echo $conversation['id'] ?>" class="sidebar-link text-decoration-none <?php echo $conversation['id'] == $id ? 'item-selected' : '';?>">
