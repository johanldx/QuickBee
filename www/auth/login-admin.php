...
writeLog('/auth/login-admin.php', "Visite de la page de connexion admin", getUserIP());
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Connexion au panel d'administration - QuickBee</title>
</head>
<style>
    body {
        width: 100%;
...
<body>
    ...
    <div class="card text-center border-1 rounded-4" style="width: 400px; display: flex; margin: auto;">
        <div class="card-body p-5">
            ...
            <p class="card-title fs-2 mb-5 fw-bold">Panel d'administration</p>
            
            <form action="backend/login-admin-process.php" method="post" class="text-center mb-3">
            ...
            <a href="login.php" class="card-link">Revenir au portail client</a>
            <br>
