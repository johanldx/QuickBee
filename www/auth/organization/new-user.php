...
$db = new Database();
$conn = $db->connect();
$sql = "SELECT id, first_name, last_name, email FROM user WHERE organization IS NULL AND email NOT LIKE 'anonymous-%@rootage.fr';";
$params = [];
...
if (!$permissions['new_user']) {
    header('Location: ' . getenv('URL_PATH') . '/auth/organization/manage-users.php?error='.urlencode("Vous ne pouvez pas créer de nouvelle clé API."));
}
...
<body>
    ...
    <div class="container card text-center border-1 rounded-4 p-5" style="display: flex; margin: auto;">
        <div class="card-body p-5">
            ...
            <form action="/auth/organization/backend/new-user-process.php" method="post" class="text-center mb-3 container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 mx-5">
                        <div class="form-floating mb-3">
                            <select class="form-select mb-3" name="user" id="user">
                                <?php 
                            ...
                            <p class="card-link">L'utilisateur ne doit pas déjà faire partie d'une entreprise.</p>
                        </div>
                ...
                <input type="submit" class="btn btn-primary btn-lg mt-3 mb-3 text-center" value="Ajouter"></input>
            </form>
        </div>
